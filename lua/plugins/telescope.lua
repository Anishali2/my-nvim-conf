...
vim.keymap.set("n", "<leader>so", function()
  ...
  require('telescope.builtin').live_grep({
    ...
    vim.keymap.set('n', '<leader>st', ":lua require('telescope.builtin').find_files({ additional_args = { '--fixed-strings','--ignore-case' }})<CR>", { desc = '[S]earch [F]iles' })
    ...
    vim.keymap.set('n', '<leader>sh', ":lua require('telescope.builtin').live_grep({ additional_args = { '--fixed-strings' }})<CR>", { desc = '[S]earch by [G]rep' })
